...
function Title() {
  ...
  return (
    <div className='mx-auto w-fit pt-10'>
      <input value={title} onChange={e => setTitle(e.target.value)} className='page-title bg-transparent text-gray-200 outline-none text-6xl focus:border-b-2 focus:border-[#00000024] text-center' type="text" />
    </div>
  );
}
